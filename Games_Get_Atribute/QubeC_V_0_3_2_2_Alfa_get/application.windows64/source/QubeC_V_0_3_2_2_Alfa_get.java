...
public class QubeC_V_0_3_2_2_Alfa_get extends PApplet {
...
Client myClient06; 
public void setup() {
  myClient01= new Client(this, "127.0.0.1", 5204); 
myClient02= new Client(this, "127.0.0.1", 5205);  
myClient03= new Client(this, "127.0.0.1", 5206);  
myClient04= new Client(this, "127.0.0.1", 5207);  
myClient05= new Client(this, "127.0.0.1", 5208);  
...
if(ship1==get((int)mouseoverx1,(int)mouseovery1)){
  ...
  sap=1;shrink++;delay(100);if(ammo>=180+v4)ammo=175+v4;
...
sap=1;
  ...
  if (mousePressed && (mouseButton == RIGHT)&&pop==1) {
   ...
   ammo=ammo+(int)random(Traktor,12);if(ammo>=Chargo+v1)ammo=Chargo+v1;
      strokeWeight(4);
       stroke(255,0,0);
    translate(20, 20,20);
  line (0, 0,  mx1, my1); 
...
if(ammo<0)ammo=+v4;
Waste=Waste+(int)random(0,2);
Traktor=Traktor+(int)random(0,2+v2/2);
...
Chargo++;
if(Traktor>=10+v2/2)Traktor=9+v2/2;
if(Waste<=0)Waste=0;
...
pop=0;
  ...
  score2=shrink-score+v5/5+v3/3;
  fill(0);
  rect(0,740,380,200);
  
  fill(255);
  text("Score: "+score2+"/100",10,765);
   text("Chargo: "+(Chargo+v1),10,785);
   text("Target: "+Target+"/2",100,765);
      text("Traktor: "+(Traktor+v2/2)+"/12+"+v2/2,100,785);
      text("Waste: "+Waste+"/2",210,765);
     
text("Force: "+(ammo+v4)+"/"+Chargo,210,785);
...
sap=0;
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "QubeC_V_0_3_2_2_Alfa_get" };
    if (passedArgs != null) {
