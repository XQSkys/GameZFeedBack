...
public class DetaMouseQubeC_V_0_2_2_6_Disco2_give extends PApplet {
...
public void setup() {
 ...
 myServer05 = new Server(this, 5208);
...
sap=0;
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "DetaMouseQubeC_V_0_2_2_6_Disco2_give" };
    if (passedArgs != null) {
