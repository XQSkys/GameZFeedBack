...
public class QubeC_V_0_3_2_2_Alfa_give extends PApplet {
...
public void setup() {
   myServer03 = new Server(this, 5206);
    fill(0);
...
sap=0;
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "QubeC_V_0_3_2_2_Alfa_give" };
    if (passedArgs != null) {
