...
public class LaboVII_Beta0_7_8_9_Room_4_give extends PApplet {
...
Server myServer02;
  public void setup() {
     myServer02 = new Server(this, 5205);
...
int i = 0;   
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "LaboVII_Beta0_7_8_9_Room_4_give" };
    if (passedArgs != null) {
