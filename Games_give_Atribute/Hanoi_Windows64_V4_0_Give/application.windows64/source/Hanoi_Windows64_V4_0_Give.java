...
public class Hanoi_Windows64_V4_0_Give extends PApplet {
...
public void setup() {
 myServer01 = new Server(this, 5204);
...
fill(0, 200, 0);                       //malt den Load button grün über
       ...
       if (mousePressed && (mouseButton == LEFT)){v2++;
if(v2==8)v2=0; PImage bild;   bild = loadImage("bild.png"); bnr=0;bnrb=0;         //lade in den bild speicher das bild mit dem namen bild.png aus dem haubptordner
  ...
  if (mousePressed && (mouseButton == RIGHT)){v1--;
if(v1==0)v1=8;
...
// hier beginnt die erzeungung und funktionalisirung des "Höhe" button:
   ...
   fill(0, 200, 0);  //setze farbe auf grün
        ...
        if (mousePressed && (mouseButton == LEFT)){runden++;; if(runden>30)runden=zint;}
...
//wichtig: hier beginnt das malen der steine
    ...
    if (xxx==0) { //hier beginnt das malen der spielsteine
      ...
      int farbe = 255/(runden/zint); //rechnet die spielsteinfarbe in abhänigkeit von der steinzahl aus
...
saveFrame("Sieg/bild####.png");
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Hanoi_Windows64_V4_0_Give" };
    if (passedArgs != null) {
