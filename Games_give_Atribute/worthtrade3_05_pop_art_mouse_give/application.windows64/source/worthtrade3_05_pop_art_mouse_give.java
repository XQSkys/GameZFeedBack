...
public class worthtrade3_05_pop_art_mouse_give extends PApplet {
...
public void setup() {
   myServer04 = new Server(this, 5207);
...
sap=0;
 ...
 if(sieg==1&&geld==0){textSize(44);fill(0);
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "worthtrade3_05_pop_art_mouse_give" };
    if (passedArgs != null) {
