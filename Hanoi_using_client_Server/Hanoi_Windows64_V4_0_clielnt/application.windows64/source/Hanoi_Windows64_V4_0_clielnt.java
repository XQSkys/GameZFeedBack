...
public class Hanoi_Windows64_V4_0_clielnt extends PApplet {
...
myClient = new Client(this, "127.0.0.1", 5209); 
...
saveFrame("Sieg/bild####.png");
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Hanoi_Windows64_V4_0_clielnt" };
    if (passedArgs != null) {
